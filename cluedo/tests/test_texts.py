...
def test_text_gossip_3():
    ...
    assert re.match('ДЕТЕКТИВ (предположил|заявил|допустил|решил): МИССИС ПИКОК убила в МАСТЕРСКОЙ (использовав|с помощью) ВЕРЁВКУ, но ПРЕПОДОБНЫЙ ГРИН опроверг', result)
