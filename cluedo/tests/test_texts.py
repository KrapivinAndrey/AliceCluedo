...
cases = {
        ...
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Гаечный ключ", "Полковник Мастрад", 0, 0, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, использовав ГАЕЧНЫЙ КЛЮЧ. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Подсвечник", "Полковник Мастрад", 0, 0, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, использовав ПОДСВЕЧНИК. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Нож", "Полковник Мастрад", 0, 0, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, использовав НОЖ. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Свинцовая труба", "Полковник Мастрад", 0, 0, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, использовав СВИНЦОВУЮ ТРУБУ. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Пистолет", "Полковник Мастрад", 0, 0, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, использовав ПИСТОЛЕТ. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Веревка", "Полковник Мастрад", 0, 0, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, использовав ВЕРЁВКУ. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
    
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Гаечный ключ", "Полковник Мастрад", 0, 1, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, с помощью ГАЕЧНОГО КЛЮЧА. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Подсвечник", "Полковник Мастрад", 0, 1, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, с помощью ПОДСВЕЧНИКА. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Нож", "Полковник Мастрад", 0, 1, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, с помощью НОЖА. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Свинцовая труба", "Полковник Мастрад", 0, 1, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, с помощью СВИНЦОВОЙ ТРУБЫ. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Пистолет", "Полковник Мастрад", 0, 1, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, с помощью ПИСТОЛЕТА. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
        (("Преподобный Грин", "Полковник Мастард", "Бильярдная", "Веревка", "Полковник Мастрад", 0, 1, 0),
        "ПРЕПОДОБНЫЙ ГРИН предположил: ПОЛКОВНИК МАСТАРД убил в БИЛЬЯРДНОЙ, с помощью ВЕРЁВКИ. Но ПОЛКОВНИК МАСТРАД сказал, что это чушь."),
