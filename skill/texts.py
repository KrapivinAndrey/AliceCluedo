...
def hello():
    ...
    Чтобы узнать как играть скажи "Помощь".
    Или "Начать игру", чтобы начать расследование"""
    tts = """Привет! Почувствуй себя настоящим сыщиком.
    Выдвигай версии, собирай факты и найди виновного.
    Чтобы узнать как играть скажи "Помощь".
    Или "Начать игру", чтобы начать расследование"""
    return text, tts
...
def help_menu(next_button=""):
    ...
    Комнаты sil <[1000]>
    Орудия sil <[1000]>"""
    if next_button == "Продолжить":
        text += """\nCкажите "Продолжить", чтобы вернуться в игру"""
        tts += """\nCкажите "Продолжить", чтобы вернуться в игру"""
    else:
        text += "\nCкажите ""Начать игру"", чтобы начать расследование"
        tts += "\nCкажите ""Начать игру"", чтобы начать расследование"

    return text, tts


def help_menu_fallback(next_button=""):
