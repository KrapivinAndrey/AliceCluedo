...
def test_add_one_image(start_session):
    ans = (
        alice.AliceResponse(start_session)
        .image("111", "test", "test image")
        .withButton("button")
        .body
    )
...
def test_add_five_images(start_session):
    ans = (
        alice.AliceResponse(start_session)
        .image("111", "test1", "test image")
        .withButton("button1")
        .image("222", "test2", "test image")
        .withButton("button2")
        .image("333", "test3", "test image")
        .withButton("button3")
        .image("444", "test4", "test image")
        .withButton("button4")
        .image("555", "test5", "test image")
        .withButton("button5")
        .body
    )
...
def test_add_seven_images(start_session):
    ans = (
        ...
        .image("555", "test5", "test image")
        .withButton("button5")
        .image("666", "test6", "test image")
        .withButton("button6")
        .image("777", "test7", "test image")
        .withButton("button7")
        .body
    )
...
def test_save_state(start_session):
    ans = alice.AliceResponse(start_session).text("test").saveState("demo", 1).body
